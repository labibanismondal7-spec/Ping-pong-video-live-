...
const rooms = { room1: { onlineUsers: [{ userId: "user-abc-123" }], seats: [] } };
initAgora({
    app: mockApp,
...
const res3 = mockRes();
registeredHandler({ authedMobile: "017...mock", body: { roomId: "room1" } }, res3);
...
const res4 = mockRes();
registeredHandler({ authedMobile: "unknown-mobile-not-in-users", body: { roomId: "room1" } }, res4);
